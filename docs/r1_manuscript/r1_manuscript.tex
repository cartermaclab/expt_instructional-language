\documentclass[man,floatsintext,donotrepeattitle,letterpaper,12pt]{apa7}
...
\authorsnames[1, 1, 2, 2, 3, 4, 5, 1]{Laura St. Germain, Brad McKay, Lidia Barbera, Chitrini Tandon, Jeswende Seedu, Chantal Carrillo, Denver M.Y. Brown, Michael J. Carter\vspace{2ex}}
...
Correspondence concerning this article should be addressed to Michael J. Carter, Department of Kinesiology, McMaster University. 1280 Main St. W., Hamilton, ON, Canada. L8S 4K1. Email: cartem11@mcmaster.ca; motorlab@mcmaster.ca}
...
\footnotetext{\textcite{parma2024} also reported that only 21\% (35 out of 166) of studies testing the motivation pillar of OPTIMAL theory actually included at least one measure of motivation.}
...
% - add in limitation about tone (Rev 1)
% - add in something related to measures that cites Parma 2024
% - also in line with above, cite past large N studies showing that these psychological effects appear to be quite small and may require even larger N studies to reliably capture
